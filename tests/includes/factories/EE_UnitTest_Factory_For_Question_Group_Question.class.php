...
/**
 * EE Factory Class for Question_Group_Question
 *
 * @since        4.3.0
 ...
 *
 */
class EE_UnitTest_Factory_For_Question_Group_Question extends EE_UnitTest_Factory_for_Model_Object {
	...
	public function __construct( $factory, $properties_and_relations = null ) {
		$this->set_model_object_name( 'Question_Group_Question' );
	...
	protected function _set_default_properties_and_relations( $called_class ) {
		...
		if ( empty( $this->_default_properties ) ) {
			$this->_default_properties = array(
				'QGQ_order' => new WP_UnitTest_Generator_Sequence()
			);
		}
...
// End of file EE_UnitTest_Factory_For_Question_Group_Question.class.php
// Location: /EE_UnitTest_Factory_For_Question_Group_Question.class.php