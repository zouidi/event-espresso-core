 ...
 *
 */
class EE_UnitTest_Factory_For_Question extends EE_UnitTest_Factory_for_Model_Object {
	...
	public function __construct( $factory, $properties_and_relations = null ) {
		$this->set_model_object_name( 'Question' );
...
// End of file EE_UnitTest_Factory_For_Question.class.php
// Location: /EE_UnitTest_Factory_For_Question.class.php