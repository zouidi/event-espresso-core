...
class EED_New_Addon extends EED_Module
{
    ...
    /**
     * @return EED_Module|EED_New_Addon
     */
    ...
    public function config()
    {
        ...
        // to piggy back off of the config setup for the base EE_New_Addon class,
    ...
    public function enqueue_scripts()
    {
        ...
        if (is_readable(EVENT_ESPRESSO_UPLOAD_DIR . 'css/new_addon.css')) {
            ...
            // EE new_addon style
            wp_register_style('espresso_new_addon', Domain::pluginUrl() . 'css/espresso_new_addon.css');
        }
        // new_addon script
        wp_register_script(
            'espresso_new_addon',
