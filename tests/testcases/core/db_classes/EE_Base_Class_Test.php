...
class EE_Base_Class_Test extends EE_UnitTestCase
{
    ...
    function test_set_defaults_on_unspecified_fields()
    {
        ...
        $this->assertEquals(
            EEM_Registration::instance()->field_settings_for('STS_ID')->get_default_value(), $r->status_ID()
        );
    }
    ...
    public function test_delete_permanently_with_extra_meta()
    {
        $attendee = EE_Attendee::new_instance(
            array('ATT_fname' => 'bob', 'ATT_lname' => 'deleteme', 'ATT_email' => 'ef@ew.dw')
        );
        $attendee->save();
    ...
    public function test_get_raw()
    {
        ...
        $qty_col_with_one_result =
            EEM_Line_Item::instance()->get_col(array(array('LIN_ID' => $l2->ID())), 'LIN_quantity');
