...
class Style {
  ...
  static $font_size_keywords = array(
    "xx-small" => 0.6,       "x-small"  => 0.75,      "small"    => 0.889,     "medium"   => 1,         "large"    => 1.2,       "x-large"  => 1.5,       "xx-large" => 2.0,     );
  ...
  function __construct(Stylesheet $stylesheet, $origin = Stylesheet::ORIG_AUTHOR) {
    ...
    if ( !isset(self::$_defaults) ) {
      ...
      $d["min_height"] = "0";
      $d["min_width"] = "0";
      $d["opacity"] = "1.0";       $d["orphans"] = "2";
      $d["outline_color"] = "";       $d["outline_style"] = "none";
      ...
      $d["richness"] = "50";
      $d["right"] = "auto";
      $d["size"] = "auto";       $d["speak_header"] = "once";
      ...
      $d["top"] = "auto";
      $d["transform"] = "none";       $d["transform_origin"] = "50% 50%";       $d["_webkit_transform"] = $d["transform"];       $d["_webkit_transform_origin"] = $d["transform_origin"];       $d["unicode_bidi"] = "normal";
  ...
  protected function _set_style_type($style,$type,$val,$important) {
    $val = preg_replace("/\s*\,\s*/", ",", $val);     $arr = explode(" ", $val);
  ...
  function set_background($val) {
    $col = null;
    $pos = array();
    $tmp = preg_replace("/\s*\,\s*/", ",", $val);     $tmp = explode(" ", $tmp);
