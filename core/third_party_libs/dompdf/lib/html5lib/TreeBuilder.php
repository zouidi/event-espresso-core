...
class HTML5_TreeBuilder {
    ...
    const LIMITED_QUIRKS_MODE   = 202;
        ...
        const NS_HTML   = null;     const NS_MATHML = 'http://www.w3.org/1998/Math/MathML';
            ...
            switch($token['name']) {
                ...
                break;
                    ...
                    for($n = $stack_length; 0 <= $n; $n--) {
                        ...
                        ($token['name'] !== 'li' && ($node->tagName == 'dc' || $node->tagName === 'dd' || $node->tagName == 'ds' || $node->tagName === 'dt'))) {                             $this->emitToken(array(
                                'type' => HTML5_Tokenizer::ENDTAG,
                                'name' => $node->tagName,
                            ));
                            break;
                ...
                case 'rp': case 'rt':
                    ...
                    $this->stack[] = $peek;                     $this->insertElement($token);
                break;
                    ...
                    while(true) {
                        ...
                        while(true) {
                            ...
                            $last_node = $node;
                                                ...
                                                if ($last_node->parentNode) {                             $last_node->parentNode->removeChild($last_node);
                        }
