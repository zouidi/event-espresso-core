...
class EE_DMS_Core_4_10_0 extends EE_Data_Migration_Script_Base{
	...
	public function pretty_name() {
		return __("Core Data Migration to version 4.10.0", "event_espresso");
	}
	...
	public function schema_changes_before_migration() {
		...
		$this->_table_has_not_changed_since_previous(
			'esp_event_question_group',
			"EQG_ID INT UNSIGNED NOT NULL AUTO_INCREMENT,
			EVT_ID BIGINT(20) UNSIGNED NOT NULL,
		...
		$this->_table_is_changed_in_this_version(
			...
			QSG_ID INT UNSIGNED NOT NULL,
			QST_name VARCHAR(100) NOT NULL,
			QST_identifier VARCHAR(100) NOT NULL,
			QST_admin_label VARCHAR(255) NOT NULL,
			QST_system VARCHAR(25) DEFAULT NULL,
			QST_type VARCHAR(25) NOT NULL DEFAULT \"TEXT\",
			QST_desc TEXT NULL,
			QST_html_name VARCHAR(100) NOT NULL,
			QST_html_id VARCHAR(100) NULL,
			QST_html_class VARCHAR(100) NULL,
		...
		$this->_table_is_changed_in_this_version(
			'esp_question_group',
			"QSG_ID INT UNSIGNED NOT NULL AUTO_INCREMENT,
			QSG_name VARCHAR(255) NOT NULL,
			QSG_identifier VARCHAR(100) NOT NULL,
			QSG_desc TEXT NULL,
			QSG_parent INT UNSIGNED NULL,
			QSG_html_name VARCHAR(100) NOT NULL,
			QSG_html_id VARCHAR(100) NULL,
			QSG_html_class VARCHAR(100) NULL,
			QSG_html_content TEXT NULL,
		...
		$this->_table_has_not_changed_since_previous(
			'esp_question_option',
			"QSO_ID INT UNSIGNED NOT NULL AUTO_INCREMENT,
		...
		$this->_table_has_not_changed_since_previous(
			'esp_status',
			"STS_ID VARCHAR(3) COLLATE utf8_bin NOT NULL,
