...
/**
 * Class RegistrantNotification
 * AutomatedActionStrategy class for sending notifications to Event Registrants
 *
 * @package       Event Espresso
 * @author        Brent Christensen
 * @since         $VID:$
 */
class RegistrantNotification extends AutomatedActionStrategy
{
...
// End of file RegistrantNotification.php
// Location: EventEspresso\core\domain\services\automated_actions/RegistrantNotification.php