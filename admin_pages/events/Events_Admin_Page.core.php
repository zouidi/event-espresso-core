...
class Events_Admin_Page extends EE_Admin_Page_CPT
{
    ...
    protected function _template_settings()
    {
        ...
        $this->_template_args['preview_text'] = '<strong>' . esc_html__(
                'Template Settings is a feature that is only available in Event Espresso 4. Template Settings allow you to configure some of the appearance options for both the Event List and Event Details pages.',
                'event_espresso'
            ) . '</strong>';
